...
eclipse_generate modules/apps/wem/application-list
eclipse_generate modules/apps/wem/asset/asset-publisher-layout-prototype
eclipse_generate modules/apps/wem/asset/asset-publisher-web
eclipse_generate modules/apps/wem/asset/asset-taglib
eclipse_generate modules/apps/wem/asset/asset-tags-navigation-web
eclipse_generate modules/apps/wem/export-import
eclipse_generate modules/apps/wem/journal
eclipse_generate modules/apps/wem/portlet-display-template
eclipse_generate modules/apps/wem/product-navigation
eclipse_generate modules/apps/wem/site
eclipse_generate modules/apps/wem/trash
...
eclipse_generate modules/portal-background-task/portal-background-task-api
eclipse_generate modules/portal-configuration
eclipse_generate modules/portal-remote/portal-remote-rest-extender-test
