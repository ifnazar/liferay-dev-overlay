...
RESOURCES_DIR=${LIFERAY_PORTAL_DIR}/modules/apps/foundation/portal-search/portal-search-elasticsearch/src/main/resources
...
# Replacements
cp   ${RESOURCES_DIR}/config/elasticsearch.yml       ${ELASTICSEARCH_DIR}/config
